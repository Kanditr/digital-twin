...
export class LeftNavArrow extends React.Component<CustomArrowProps> {
  render() {
    return <button onClick={this.props.onClick}>Next</button>;
  }
}

export function RightNavArrow(props: CustomArrowProps): JSX.Element {
...
export class SliderTest extends React.Component {
